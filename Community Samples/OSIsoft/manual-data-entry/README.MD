...
1. Replace the last line in the sym-sendvalue.js file with **})(window.PIVisualization)**;
...
2. In the sym-sendvalue-config.html, replace all occurrences of **cs-color-picker** with **pv-color-picker**.
